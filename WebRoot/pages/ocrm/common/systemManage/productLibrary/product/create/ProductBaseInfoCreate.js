...
ObjectUtil
		.define(
				"crm.pages.ocrm.common.systemManage.productLibrary.product.create.ProductBaseInfoCreate",
				"base.PageObject",
				{
					htmlUrl : Constants.CONTEXT_PATH
							+ "/pages/ocrm/common/systemManage/productLibrary/product/create/ProductBaseInfoCreate.html",// 页面url地址
					/**
					 * 初始化页面数据
					 * 
					 * @param
									...
									callback : function(data) {
										...
										var compCheckbox = owner
												.create(
														...
														{
															renderTo : owner.ids.prodmeloncuttingmodeDiv,
															...
															id : 'prodmeloncuttingmodeUpdateCheckbox',
															itemClick : function() {
										...
										var compRadio = owner
												.create(
														"component.CheckboxRadioField",
														{
															renderTo : owner.ids.prodaheadpauseDiv,
															name : 'prodaheadpause',
															fieldType : 'radio',
															disabled : false,
															labelWidth : 100,
										...
										DataUtil
												.populateDataForArea(
														...
														owner.ids.productBaseInfoCreateContentDiv);// 渲染数据到页面
									}
								});
					},
					/**
					...
					initCmp : function() {
						...
						// renderTo : this.ids.prodmeloncuttingmodeDiv,
						// name:'prodmeloncuttingmodeList',
						// fieldType:'checkbox',
						// disabled : false,
						...
						// id : 'prodmeloncuttingmodeCheckbox',
						// itemClick : function(){
						//				
						// }
						// });
						...
						// var compRadio =
						// this.create("component.CheckboxRadioField", {
						// renderTo : this.ids.prodaheadpauseDiv,
						// name:'prodaheadpause',
						// fieldType:'radio',
						// disabled : false,
						// labelWidth : 100,
						...
						this
								.create(
										'component.Panel',
										{
											title : '',
											// id :
											// "productBaseInfoCreatePanel",
											contentEl : this.ids.productBaseInfoCreateContentDiv,
											renderTo : this.ids.productBaseInfoCreatePanelDiv,
											// height : 560,
											widthPercent : 0.9845,
											heightPercent : 1.36,
					...
					createBaseInfo : function() {
						...
						var data = DataUtil
								.getDataFromArea(owner.ids.productBaseInfoCreateContentDiv);// 获取页面输入的信息并自动验证
