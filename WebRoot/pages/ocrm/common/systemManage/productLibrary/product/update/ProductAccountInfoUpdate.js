...
ObjectUtil
		.define(
				"crm.pages.ocrm.common.systemManage.productLibrary.product.update.ProductAccountInfoUpdate",
				"base.PageObject",
				{
					htmlUrl : Constants.CONTEXT_PATH
							+ "/pages/ocrm/common/systemManage/productLibrary/product/update/ProductAccountInfoUpdate.html",// 页面url地址
						...
						ConnectionUtil.ajaxReq( {
							...
							callback : function(data) {
								DataUtil.populateDataForArea(data.productAccountInfoBean,
										owner.ids.productAccountInfoUpdateContentDiv);// 渲染数据到页面
							}
						});
					},
	/**
	...
	initCmp : function() {			
		...
		this.create('component.Panel',{
			title : '',
			//id : "productAccountInfoUpdatePanel",
			contentEl : this.ids.productAccountInfoUpdateContentDiv,
			renderTo : this.ids.productAccountInfoUpdatePanelDiv,
			//height : 275,
			widthPercent : 1,
			heightPercent : 0.625,
	...
	updateAccountInfo : function() {
		var owner = this;
		var data = DataUtil.getDataFromArea(owner.ids.productAccountInfoUpdateContentDiv);// 获取页面输入的信息并自动验证
