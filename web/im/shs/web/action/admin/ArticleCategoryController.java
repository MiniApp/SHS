...
public class ArticleCategoryController extends BaseAdminController {
    ...
    /** 索引重定向URL */
    private static final String INDEX_REDIRECT_URL = "redirect:/admin/article_category";

    /** 模板路径 */
    private static final String TEMPLATE_PATH = "/admin/article_category";
