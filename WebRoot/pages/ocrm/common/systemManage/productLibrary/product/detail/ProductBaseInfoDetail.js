...
ObjectUtil
		.define(
				"crm.pages.ocrm.common.systemManage.productLibrary.product.detail.ProductBaseInfoDetail",
				"base.PageObject",
				{
					htmlUrl : Constants.CONTEXT_PATH
							+ "/pages/ocrm/common/systemManage/productLibrary/product/detail/ProductBaseInfoDetail.html",// 页面url地址
...
//											renderTo : owner.ids.prodaheadpauseDetailDiv,
//											name:'prodaheadpause',
//											fieldType:'radio',
//											disabled : false,
//									        labelWidth : 100,
...
//										});
										DataUtil
												.populateDataForArea(
														...
														owner.ids.productBaseInfoDetailContentDiv);// 渲染数据到页面
									}
								});
					},
					/**
...
//							renderTo : this.ids.prodmeloncuttingmodeDetailDiv,
...
//							id : 'prodmeloncuttingmodeDetailCheckbox',
//							itemClick : function(){
//								
//							}
//						});
						...
						this
								.create(
										...
										{
											title : '',
											//id : "productBaseInfoDetailPanel",
											contentEl : this.ids.productBaseInfoDetailContentDiv,
											renderTo : this.ids.productBaseInfoDetailPanelDiv,
											//height : 560,
											widthPercent : 1,
											heightPercent : 1,
