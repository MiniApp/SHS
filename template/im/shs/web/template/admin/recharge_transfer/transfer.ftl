...
[#-- 索引URL --]
[#assign indexUrl = baseUrl + "/recharge_transfer" /]
<!DOCTYPE html>
<html lang="en">
	<head>
		[#-- meta 标签 --]
		...
		[#-- 标题 --]
		<title>转账充值[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
		...
		<div class="form-horizontal">
			...
			<div class="tabbable">
				...
				<ul class="nav nav-tabs">
					...
					[/#if]
					<li>
						<a id="transfer_tab" href="#transfer" data-toggle="tab">充值转账</a>
					</li>
				</ul>
	...
	[#-- recharge.transfer 充值转账 --]
	<script type="text/javascript" src="${base}/resources/admin/js/recharge.transfer.min.js"></script>
    [#-- 有瞬时消息时 --]
	[#if flashMessage != null]
	    [#-- HubSpot Messenger 弹框（Alert）组件库 --]
