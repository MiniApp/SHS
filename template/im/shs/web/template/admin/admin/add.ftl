...
<html lang="en">
	<head>
		...
		[#-- 标题 --]
		<title>添加管理员[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
				...
				<div class="tab-content">
					...
					<div id="tab_pane2" class="tab-pane" tab-id="tab2">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input id="department" class="form-control" type="text" name="department" maxlength="200" />
							</div>
						</div>
	...
	[#-- admin.add 管理员添加 --]
	<script type="text/javascript" src="${base}/resources/admin/js/admin.add.min.js"></script>
    [#-- 有瞬时消息时 --]
	[#if flashMessage != null]
	    [#-- HubSpot Messenger 弹框（Alert）组件库 --]
