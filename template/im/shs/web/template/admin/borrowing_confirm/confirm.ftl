...
<html lang="en">
	<head>
		...
		[#-- 标题 --]
		<title>确认借款[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
    ...
    [#-- borrowing.confirm 借款确认 --]
	<script type="text/javascript" src="${base}/resources/admin/js/borrowing.confirm.min.js"></script>
    [#-- 有瞬时消息时 --]
	[#if flashMessage != null]
	    [#-- HubSpot Messenger 弹框（Alert）组件库 --]
