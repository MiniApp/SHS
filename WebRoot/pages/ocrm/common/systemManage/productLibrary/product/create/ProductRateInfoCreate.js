...
ObjectUtil
		.define(
				"crm.pages.ocrm.common.systemManage.productLibrary.product.create.ProductRateInfoCreate",
				"base.PageObject",
				{
					htmlUrl : Constants.CONTEXT_PATH
							+ "/pages/ocrm/common/systemManage/productLibrary/product/create/ProductRateInfoCreate.html",// 页面url地址
					/**
					 * 初始化页面数据
					 * 
					 * @param
									...
									callback : function(data) {
										DataUtil
												.populateDataForArea(
														...
														owner.ids.productRateInfoCreateContentDiv);// 渲染数据到页面
									}
								});
					},
					/**
						...
						this
								.create(
										'component.Panel',
										{
											title : '',
											// id :
											// "productRateInfoCreatePanel",
											contentEl : this.ids.productRateInfoCreateContentDiv,
											renderTo : this.ids.productRateInfoCreatePanelDiv,
					...
					createRateInfo : function() {
						...
						var data = DataUtil
								.getDataFromArea(owner.ids.productRateInfoCreateContentDiv);// 获取页面输入的信息并自动验证
