...
<html lang="en">
	<head>
		...
		[#-- 标题 --]
		<title>编辑广告位[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
    ...
    <body class="contentwrapper">
		...
		<form id="inputForm" class="form-horizontal" action="${indexUrl}/${adPosition.id}" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input id="name" class="form-control" type="text" name="name" value="${adPosition.name}" maxlength="200" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input id="ident" class="form-control uppercase" type="text" name="ident" value="${adPosition.ident}" maxlength="100" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="input-group col-sm-2">
					...
					<input id="width" class="form-control" type="text" name="width" value="${adPosition.width}" maxlength="4" />
					<label class="input-group-addon">像素</label>
				</div>
				<div class="input-group col-sm-2">
					<label for="height" class="input-group-addon">高度</label>
					<input id="height" class="form-control" type="text" name="height" value="${adPosition.height}" maxlength="4" />
					<label class="input-group-addon">像素</label>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<textarea id="description" class="form-control" name="description" cols="10" rows="5">${adPosition.description}</textarea>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<textarea id="template" class="form-control" name="template" cols="20" rows="10">[/@compress]${adPosition.template?html}[@compress single_line = !systemDevelopment]</textarea>
				</div>
			</div>
