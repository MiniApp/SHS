 ...
 * @Update:2012-11-14
 */
ObjectUtil.define("crm.pages.ocrm.common.report.ReportDemo20007", "base.PageObject", {
	htmlUrl : Constants.CONTEXT_PATH + "/pages/ocrm/common/report/ReportDemo20007.html",
	initCmp : function() {
		var owner = this;
		this.create(
...
//			date = DataUtil.encode(date);
		...
		if(date.rptchange=="1"){
			ObjectUtil.applyIf(date,{"rpt":"TheCountOfCustomerBelongToOtherOrganForBrance.brt"});
