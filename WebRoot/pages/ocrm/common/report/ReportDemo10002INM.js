 ...
 * @Update:2012-11-14
 */
ObjectUtil.define("crm.pages.ocrm.common.report.ReportDemo10002INM", "base.PageObject", {
	htmlUrl : Constants.CONTEXT_PATH + "/pages/ocrm/common/report/ReportDemo10002INM.html",
	initCmp : function() {
		var owner = this;
		this.create(
	 ...
	 */
	getData : function() {
		var date = DataUtil.decode(DataUtil.getDataFromArea(this.ids.ReportSearchContentPanelDiv10002INM));
