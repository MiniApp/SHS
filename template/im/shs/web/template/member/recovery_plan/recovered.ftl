      	...
      	<div class="right-content pull-right">
            ...
            <div class="invest">
            	<div class="invest-title">
                	<ul>
                    	<li><a href="${base}/account/recovery_plan?state=recovering">待收的回账</a></li>
                        <li><a href="javascript:void(0);" class="active">已收的回账</a></li>
                    </ul>
                </div>
                    ...
                    <table>
						...
						[#list page.cont as recoveryPlan]
							...
							<tr>
								...
								<td>${recoveryPlan.recoveredCapital?string("currency")}</td>
								<td>${recoveryPlan.recoveredInterest?string("currency")}</td>
								<td>${recoveryPlan.paidFee?string("currency")}</td>
								<td>${recoveryPlan.recoveredIncome?string("currency")}</td>
								<td>${recoveryPlan.recoveredDate?string("yyyy-MM-dd")}</td>
							</tr>
						[/#list]
		                [#if page.cont?size == 0]
		                    <tr>
