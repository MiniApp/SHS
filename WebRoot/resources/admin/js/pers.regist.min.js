	...
	$inputForm.validate({
		rules: {
			username: {
				...
				maxlength: 20,
				remote: {
					url: "/SHS/admin/pers_regist/check_username",
					type: "post",
					cache: false
				}
			},
			...
			idNo: {
				...
				remote: {
					url: "/SHS/admin/pers_regist/check_id_no",
					type: "post",
					cache: false
				}
			},
			email: {
				email: true,
				remote: {
					url: "/SHS/admin/pers_regist/check_email",
					type: "post",
					cache: false
				}
			},
			mobile: {
				pattern: /^1[3,5,8]\d{9}$/,
				remote: {
					url: "/SHS/admin/pers_regist/check_mobile",
					type: "post",
					cache: false
				}
			},
