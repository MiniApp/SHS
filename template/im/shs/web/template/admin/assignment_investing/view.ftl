...
[#-- 索引URL --]
[#assign indexUrl = baseUrl + "/assignment_investing" /]
<!DOCTYPE html>
<html lang="en">
	<head>
		[#-- meta 标签 --]
		...
		[#-- 标题 --]
		<title>查看投资中的转让[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
		...
		<div class="form-horizontal">
			...
			<div class="tabbable">
				...
				<ul class="nav nav-tabs">
					...
					<li>
						<a id="borrower_tab" href="#borrower" data-toggle="tab">转让人信息</a>
					</li>
					[#-- 投资信息 --]
