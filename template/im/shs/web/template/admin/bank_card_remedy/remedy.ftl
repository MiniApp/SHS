...
<html lang="en">
	<head>
		...
		[#-- 标题 --]
		<title>补救银行卡[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
		...
		<div class="form-horizontal">
			...
			<div class="tabbable">
				...
				<ul class="nav nav-tabs">
					...
					[/#if]
					<li>
						<a id="remedy_tab" href="#remedy" data-toggle="tab">银行卡补救</a>
					</li>
				</ul>
	...
	[#-- bank_card.remedy 银行卡补救 --]
	<script type="text/javascript" src="${base}/resources/admin/js/bank_card.remedy.min.js"></script>
    [#-- 有瞬时消息时 --]
	[#if flashMessage != null]
	    [#-- HubSpot Messenger 弹框（Alert）组件库 --]
