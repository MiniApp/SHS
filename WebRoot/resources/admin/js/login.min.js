...
$().ready( function() {
	...
	$loginForm.validate({
		...
		submitHandler: function(form) {
			...
			$.ajax({
				url: "/P2P-2.0-YuXinChuangTou/admin/login",
				data: {
	...
	if(remember != null) {
		...
		$captchaImage.click(function() {
			$captchaImage.prop("src", "/P2P-2.0-YuXinChuangTou/admin/captcha?captchaId=" + captchaId + "&timestamp=" + (new Date()).valueOf());
		});
