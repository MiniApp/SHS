	...
	$inputForm.validate({
		rules: {
			...
			idNo: {
				...
				remote: {
					url: "/P2P-2.0-YuXinChuangTou/admin/member_modif/check_id_no",
			...
			email: {
				email: true,
				remote: {
					url: "/P2P-2.0-YuXinChuangTou/admin/member_modif/check_email",
			...
			mobile: {
				pattern: /^1[3,5,8]\d{9}$/,
				remote: {
					url: "/P2P-2.0-YuXinChuangTou/admin/member_modif/check_mobile",
