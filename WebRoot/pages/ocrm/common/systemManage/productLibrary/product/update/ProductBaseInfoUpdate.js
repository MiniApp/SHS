...
ObjectUtil
		.define(
				"crm.pages.ocrm.common.systemManage.productLibrary.product.update.ProductBaseInfoUpdate",
				"base.PageObject",
				{
					htmlUrl : Constants.CONTEXT_PATH
							+ "/pages/ocrm/common/systemManage/productLibrary/product/update/ProductBaseInfoUpdate.html",// 页面url地址
								...
								.ajaxReq( {
									...
									callback : function(data) {
										...
										var compCheckbox = owner.create("component.CheckboxRadioField", {
											renderTo : owner.ids.prodmeloncuttingmodeUpdateDiv,
										...
										var compRadio = owner.create("component.CheckboxRadioField", {
											renderTo : owner.ids.prodaheadpauseUpdateDiv,
											name:'prodaheadpause',
											fieldType:'radio',
											disabled : false,
									        labelWidth : 100,
										...
										DataUtil
												.populateDataForArea(
														...
														owner.ids.productBaseInfoUpdateContentDiv);// 渲染数据到页面
									}
								});
					},
					/**
					...
					initCmp : function() {
						...
						this
								.create(
										...
										{
											title : '',
											//id : "productBaseInfoUpdatePanel",
											contentEl : this.ids.productBaseInfoUpdateContentDiv,
											renderTo : this.ids.productBaseInfoUpdatePanelDiv,
											//height : 560,
											widthPercent : 0.9845,
											heightPercent : 1.36,
					...
					updateBaseInfo : function() {
						var owner = this;
						var data = DataUtil
								.getDataFromArea(owner.ids.productBaseInfoUpdateContentDiv);// 获取页面输入的信息并自动验证
