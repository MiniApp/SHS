	...
	<div class="col-sm-4">
		<select id="assignationTime" class="form-control chosen-select" name="assignationTime" data-placeholder="&nbsp;">
			...
			[#list assignationTimes as assignationTime]
				<option value="${assignationTime}">${message("LendingTime." + assignationTime)}</option>
			[/#list]
			--]
			[#assign assignationTime = "after_each_investment" /]
			<option value="${assignationTime}">${message("LendingTime." + assignationTime)}</option>
		</select>
	</div>
</div>
	...
	<div class="col-sm-4">
		<select id="buybackMethod" class="form-control chosen-select" name="buybackMethod" data-placeholder="&nbsp;">
			...
			[#list buybackMethods as buybackMethod]
				<option value="${buybackMethod}">${message("RepaymentMethod." + buybackMethod)}</option>
			[/#list]
		</select>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="input-group col-sm-4">
		<input id="prebuybackFeeRate" class="form-control" type="text" name="prebuybackFeeRate" value="0" maxlength="20" autocomplete="off" />
		<label class="input-group-addon">%</label>
	</div>
</div>
--]
...
<div class="form-group">
	...
	<div class="input-group col-sm-4">
		<input id="buybackFeeRate" class="form-control" type="text" name="buybackFeeRate" value="0" maxlength="20" autocomplete="off" />
		<label class="input-group-addon">%</label>
	</div>
</div>
