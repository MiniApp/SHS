...
<html lang="en">
	<head>
		...
		[#-- 标题 --]
		<title>撤销借款调查[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
	...
	[#-- borrowing.inquiry.rescind 借款调查撤销 --]
	<script type="text/javascript" src="${base}/resources/admin/js/borrowing.inquiry.rescind.min.js"></script>
    [#-- 有瞬时消息时 --]
	[#if flashMessage != null]
	    [#-- HubSpot Messenger 弹框（Alert）组件库 --]
