...
ObjectUtil
		.define(
				"crm.pages.ocrm.common.systemManage.productLibrary.productTemplate.update.TemplateIncomeInfoUpdate",
				"base.PageObject",
				{
					htmlUrl : Constants.CONTEXT_PATH
							+ "/pages/ocrm/common/systemManage/productLibrary/productTemplate/update/TemplateIncomeInfoUpdate.html",// 页面url地址
									...
									callback : function(data) {
										...
										DataUtil
												.populateDataForArea(
														...
														owner.ids.templateIncomeInfoUpdateContentDiv);// 渲染数据到页面
									}
								});
					},
					...
					initCmp : function() {
						...
						this
								.create(
										...
										{
											title : '',
											//id : "templateIncomeInfoUpdatePanel",
											contentEl : this.ids.templateIncomeInfoUpdateContentDiv,
											renderTo : this.ids.templateIncomeInfoUpdatePanelDiv,
					...
					updateIncomeInfo : function() {
						var owner = this;
						var data = DataUtil
								.getDataFromArea(owner.ids.templateIncomeInfoUpdateContentDiv);// 获取页面输入的信息并自动验证
