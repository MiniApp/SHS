	...
	<div class="col-sm-4">
		<select id="staffSize" class="form-control chosen-select" name="staffSize" data-placeholder="&nbsp;">
			...
			[#list staffSizes as staffSize]
				<option value="${staffSize}">${staffSize}</option>
			[/#list]
		</select>
	</div>
</div>
	...
	<div class="col-sm-4">
		<select id="assetSize" class="form-control chosen-select" name="assetSize" data-placeholder="&nbsp;">
			...
			[#list assetSizes as assetSize]
				<option value="${assetSize}">${assetSize}</option>
			[/#list]
		</select>
	</div>
</div>
	...
	<div class="col-sm-4">
		<select id="operatedPeriod" class="form-control chosen-select" name="operatedPeriod" data-placeholder="&nbsp;">
			...
			[#list operatedPeriods as operatedPeriod]
				<option value="${operatedPeriod}">${operatedPeriod}</option>
			[/#list]
		</select>
	</div>
</div>
	...
	<div class="col-sm-4">
		<select id="prevYearOperatedRevenue" class="form-control chosen-select" name="prevYearOperatedRevenue" data-placeholder="&nbsp;">
			...
			[#list prevYearOperatedRevenues as prevYearOperatedRevenue]
				<option value="${prevYearOperatedRevenue}">${prevYearOperatedRevenue}</option>
			[/#list]
		</select>
	</div>
</div>
	...
	<div class="col-sm-4">
		<select id="registeredCapital" class="form-control chosen-select" name="registeredCapital" data-placeholder="&nbsp;">
			...
			[#list registeredCapitals as registeredCapital]
				<option value="${registeredCapital}">${registeredCapital}</option>
			[/#list]
		</select>
	</div>
</div>
...
<div class="form-group">
	...
	<input class="selectSascade" type="hidden" name="locality" />
</div>
...
<div class="form-group">
	...
	<div class="col-sm-4">
		<input id="addr" class="form-control" type="text" name="addr" maxlength="200" />
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-4">
		<input id="zipcode" class="form-control" type="text" name="zipcode" maxlength="200" />
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-4">
		<input id="licenseNo" class="form-control" type="text" name="licenseNo" maxlength="200" />
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-4">
		<input id="licenseIssueDate" class="form-control datetimepicker datetimepicker-yyyy-MM-dd" type="text" name="licenseIssueDate" />
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-4">
		<input id="licenseExpiryDate" class="form-control datetimepicker datetimepicker-yyyy-MM-dd" type="text" name="licenseExpiryDate" />
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-4">
		<input id="nationalTaxNo" class="form-control" type="text" name="nationalTaxNo" maxlength="200" />
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-4">
		<input id="landTaxNo" class="form-control" type="text" name="landTaxNo" maxlength="200" />
	</div>
</div>
