...
ObjectUtil
		.define(
				"crm.pages.ocrm.common.systemManage.productLibrary.productTemplate.create.TemplateSellAreaInfoCreate",
				"base.PageObject",
				{
					htmlUrl : Constants.CONTEXT_PATH
							+ "/pages/ocrm/common/systemManage/productLibrary/productTemplate/create/TemplateSellAreaInfoCreate.html",// 页面url地址
					/**
					 * 初始化页面数据
					 * 
					 * @param
									...
									callback : function(data) {
										DataUtil
												.populateDataForArea(
														...
														owner.ids.templateSellAreaInfoCreateContectDiv);// 渲染数据到页面
									}
								});
					},
					/**
						...
						this
								.create(
										'component.Panel',
										{
											title : '',
											// id :
											// "templateSellAreaInfoCreatePanel",
											contentEl : this.ids.templateSellAreaInfoCreateContectDiv,
											renderTo : this.ids.templateSellAreaInfoCreatePanelDiv,
					...
					createSellAreaInfo : function() {
						...
						var data = DataUtil
								.getDataFromArea(owner.ids.templateSellAreaInfoCreateContectDiv);// 获取页面输入的信息并自动验证
