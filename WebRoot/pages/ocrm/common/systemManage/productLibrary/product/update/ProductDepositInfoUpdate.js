...
ObjectUtil
		.define(
				"crm.pages.ocrm.common.systemManage.productLibrary.product.update.ProductDepositInfoUpdate",
				"base.PageObject",
				{
					htmlUrl : Constants.CONTEXT_PATH
							+ "/pages/ocrm/common/systemManage/productLibrary/product/update/ProductDepositInfoUpdate.html",// 页面url地址
	...
	initData : function() {
		               ...
		               var owner = this;						
						...
						ConnectionUtil.ajaxReq( {
							strServId : "productManageService.getDepositInfoById",
	...
	updateIdentify : function(){
		...
		if (data != Constants.VALIDATION_FAIL) {// 如果data不等Constants.VALIDATION_FAIL则表示验证通过
			...
			ConnectionUtil.ajaxReq({// 发送ajax请求
				strServId : "productManageService.updateDepositInfo",
				jsonData : newData,
				callback : function(msg) {
					MsgUtil.alert("提示", "存款产品信息修改成功!");
