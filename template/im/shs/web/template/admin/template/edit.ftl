...
<html lang="en">
	<head>
		...
		[#-- 标题 --]
		<title>编辑${message("TemplateType." + templateType)}模板[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
    ...
    <body class="contentwrapper">
		...
		<div id="jBreadCrumb" class="breadCrumb module">
			<ul>
				...
				<li>
					编辑${message("TemplateType." + templateType)}模板
				</li>
				<li>
					模板：${template}
				</li>
		...
		<form id="inputForm" class="form-horizontal" action="${indexUrl}/${template.id}" method="post">
			...
			<div class="form-group">
				<textarea id="cont" class="form-control" name="cont" style="width: 100%; height: 450px; padding: 0px;">[/@compress]${cont?html}[@compress single_line = !systemDevelopment]</textarea>
			</div>
	...
	[#-- template.edit 模板编辑 --]
	<script type="text/javascript" src="${base}/resources/admin/js/template.edit.min.js"></script>
    [#-- 有瞬时消息时 --]
	[#if flashMessage != null]
	    [#-- HubSpot Messenger 弹框（Alert）组件库 --]
