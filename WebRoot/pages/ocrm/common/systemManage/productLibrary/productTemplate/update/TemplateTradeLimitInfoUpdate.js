...
ObjectUtil
		.define(
				"crm.pages.ocrm.common.systemManage.productLibrary.productTemplate.update.TemplateTradeLimitInfoUpdate",
				"base.PageObject",
				{
					htmlUrl : Constants.CONTEXT_PATH
							+ "/pages/ocrm/common/systemManage/productLibrary/productTemplate/update/TemplateTradeLimitInfoUpdate.html",// 页面url地址
						...
						ConnectionUtil.ajaxReq( {
							...
							callback : function(data) {
								...
								var compCheckbox = owner.create("component.CheckboxRadioField", {
									renderTo : owner.ids.tmpProdFuncLimitUpdateDiv,
								...
								DataUtil.populateDataForArea(data.productTradeLimitInfoBean,
										owner.ids.templateTradeLimitInfoUpdateContentDiv);// 渲染数据到页面
							}
						});
					},
...
//				});
		...
		this.create('component.Panel',{
			title : '',
			//id : "templateTradeLimitInfoUpdatePanel",
			contentEl : this.ids.templateTradeLimitInfoUpdateContentDiv,
			renderTo : this.ids.templateTradeLimitInfoUpdatePanelDiv,
	...
	updateTradeLimitInfo : function() {
		var owner = this;
		var data = DataUtil.getDataFromArea(owner.ids.templateTradeLimitInfoUpdateContentDiv);// 获取页面输入的信息并自动验证
