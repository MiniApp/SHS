...
[#-- 索引URL --]
[#assign indexUrl = baseUrl + "/recharge_cancel" /]
<!DOCTYPE html>
<html lang="en">
	<head>
		[#-- meta 标签 --]
		...
		[#-- 标题 --]
		<title>取消充值[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
		...
		<div class="form-horizontal">
			...
			<div class="tabbable">
				...
				<ul class="nav nav-tabs">
					...
					[/#if]
					<li>
						<a id="cancel_tab" href="#cancel" data-toggle="tab">充值取消</a>
					</li>
				</ul>
	...
	[#-- recharge.cancel 充值取消 --]
	<script type="text/javascript" src="${base}/resources/admin/js/recharge.cancel.min.js"></script>
    [#-- 有瞬时消息时 --]
	[#if flashMessage != null]
	    [#-- HubSpot Messenger 弹框（Alert）组件库 --]
