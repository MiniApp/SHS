...
ObjectUtil
		.define(
				"crm.pages.ocrm.common.systemManage.productLibrary.productTemplate.detail.TemplateTradeLimitInfoDetail",
				"base.PageObject",
				{
					htmlUrl : Constants.CONTEXT_PATH
							+ "/pages/ocrm/common/systemManage/productLibrary/productTemplate/detail/TemplateTradeLimitInfoDetail.html",// 页面url地址
						...
						ConnectionUtil.ajaxReq( {
							...
							callback : function(data) {
								DataUtil.populateDataForArea(data.productTradeLimitInfoBean,
										owner.ids.templateTradeLimitInfoDetailContentDiv);// 渲染数据到页面
							}
						});
					},
...
//			renderTo : this.ids.tmpProdFuncLimitDetailDiv,
...
//			id : 'tmpProdFuncLimitDetailCheckbox',
//			itemClick : function(){
//			
//			}
//		});
		...
		this.create('component.Panel',{
			title : '',
			//id : "templateTradeLimitInfoDetailPanel",
			contentEl : this.ids.templateTradeLimitInfoDetailContentDiv,
			renderTo : this.ids.templateTradeLimitInfoDetailPanelDiv,
