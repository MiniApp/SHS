...
<html lang="en">
	<head>
		...
		[#-- 标题 --]
		<title>账户充值[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
		...
		<div class="form-horizontal">
			...
			<div class="tabbable">
				...
				<ul class="nav nav-tabs">
					...
					<li>
						<a id="recharge_tab" href="#recharge" data-toggle="tab">账户充值</a>
					</li>
				</ul>
				...
				<div class="tab-content">
					...
					[#-- 账户充值 --]
					<div id="recharge" class="tab-pane" tab-id="recharge_tab">
				    	[#-- 表单 --]
						<form id="inputForm" action="${indexUrl}/${id}" method="post">
							...
							[#-- 充值账户 --]
							[#include "/template/admin/account/recharge/basic.ftl" /]
	...
	<script type="text/javascript" src="${base}/resources/admin/js/account.recharge.min.js"></script>
    [#-- 有瞬时消息时 --]
	[#if flashMessage != null]
	    [#-- HubSpot Messenger 弹框（Alert）组件库 --]
