...
[#-- 索引URL --]
[#assign indexUrl = baseUrl + "/withdrawal_cancel" /]
<!DOCTYPE html>
<html lang="en">
	<head>
		[#-- meta 标签 --]
		...
		[#-- 标题 --]
		<title>取消提现[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
		...
		<div class="form-horizontal">
			...
			<div class="tabbable">
				...
				<ul class="nav nav-tabs">
					...
					[/#if]
					<li>
						<a id="cancel_tab" href="#cancel" data-toggle="tab">提现取消</a>
					</li>
				</ul>
				...
				<div class="tab-content">
					...
					[#-- 提现取消 --]
					<div id="cancel" class="tab-pane" tab-id="cancel_tab">
				    	[#-- 表单 --]
	...
	[#-- withdrawal.cancel 提现取消 --]
	<script type="text/javascript" src="${base}/resources/admin/js/withdrawal.cancel.min.js"></script>
    [#-- 有瞬时消息时 --]
	[#if flashMessage != null]
	    [#-- HubSpot Messenger 弹框（Alert）组件库 --]
