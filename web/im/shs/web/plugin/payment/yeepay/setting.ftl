...
<html lang="en">
	<head>
		...
		[#-- 标题 --]
		<title>设置易宝支付[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
	...
	[#-- payment_plugin.yeepay.setting 易宝支付设置 --]
	<script type="text/javascript" src="${base}/resources/admin/js/payment_plugin.yeepay.setting.min.js"></script>
    [#-- 有瞬时消息时 --]
	[#if flashMessage != null]
	    [#-- HubSpot Messenger 弹框（Alert）组件库 --]
