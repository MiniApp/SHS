...
[#-- 索引URL --]
[#assign indexUrl = baseUrl + "/borrowing_repayment" /]
<!DOCTYPE html>
<html lang="en">
	<head>
		[#-- meta 标签 --]
		...
		[#-- 标题 --]
		<title>待还款的还款[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
    ...
    <body class="contentwrapper">
		...
		<table class="table table-striped table-bordered dataTable">
			...
			<tbody>
				[#list list as repayment]
					<tr>
						[#-- 还款 List TD --]
						[#include "/template/admin/repayment/list_tds.ftl" /]
				        <td class="center">
				        	<a href="${baseUrl}/borrowing_repayment_record?repayment=${repayment.id}">
		...
		<div class="hide">
		    ...
		    <div class="dataTableActions">
				...
				[/#if]
		        <div class="btn-group">
					<a href="${indexUrl}[#if borrowing??]?borrowing=${borrowing}[/#if]" class="btn btn-default btn-sm">
