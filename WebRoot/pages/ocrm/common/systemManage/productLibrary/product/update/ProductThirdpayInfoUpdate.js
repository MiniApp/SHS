...
ObjectUtil
		.define(
				"crm.pages.ocrm.common.systemManage.productLibrary.product.update.ProductThirdpayInfoUpdate",
				"base.PageObject",
				{
					htmlUrl : Constants.CONTEXT_PATH
							+ "/pages/ocrm/common/systemManage/productLibrary/product/update/ProductThirdpayInfoUpdate.html",// 页面url地址
	...
	initData : function() {
		               ...
		               var owner = this;						
						...
						ConnectionUtil.ajaxReq( {
							strServId : "productManageService.getThirdpayInfoById",
	...
	updateIdentify : function(){
		...
		if (data != Constants.VALIDATION_FAIL) {// 如果data不等Constants.VALIDATION_FAIL则表示验证通过
			...
			ConnectionUtil.ajaxReq({// 发送ajax请求
				strServId : "productManageService.updateThirdpayInfo",
				jsonData : newData,
				callback : function(msg) {
					MsgUtil.alert("提示", "第三方支付产品信息修改成功!");
