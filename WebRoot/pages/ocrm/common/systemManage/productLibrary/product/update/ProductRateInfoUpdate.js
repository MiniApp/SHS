...
ObjectUtil
		.define(
				"crm.pages.ocrm.common.systemManage.productLibrary.product.update.ProductRateInfoUpdate",
				"base.PageObject",
				{
					htmlUrl : Constants.CONTEXT_PATH
							+ "/pages/ocrm/common/systemManage/productLibrary/product/update/ProductRateInfoUpdate.html",// 页面url地址
						...
						ConnectionUtil.ajaxReq( {
							...
							callback : function(data) {
								DataUtil.populateDataForArea(data.productRateInfoBean,
										owner.ids.productRateInfoUpdateContentDiv);// 渲染数据到页面
							}
						});
					},
...
//	
		...
		this.create('component.Panel',{
			title : '',
			//id : "productRateInfoUpdatePanel",
			contentEl : this.ids.productRateInfoUpdateContentDiv,
			renderTo : this.ids.productRateInfoUpdatePanelDiv,
	...
	updateRateInfo : function() {
		var owner = this;
		var data = DataUtil.getDataFromArea(owner.ids.productRateInfoUpdateContentDiv);// 获取页面输入的信息并自动验证
