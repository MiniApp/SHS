		...
		<form id="inputForm" class="form-horizontal" action="${indexUrl}/${articleCategory.id}" method="post">
				...
				<div class="tab-content">
					...
					<div id="basic" class="tab-pane active" tab-id="basic_tab">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input id="name" class="form-control" type="text" name="name" value="${articleCategory.name}" maxlength="20" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input id="alias" class="form-control" type="text" name="alias" value="${articleCategory.alias}" maxlength="100" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input id="templateId" class="form-control" type="text" name="template" value="${articleCategory.template}" maxlength="200" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea id="description" class="form-control" name="description" cols="10" rows="5">${articleCategory.description}</textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input id="order" class="form-control" type="text" name="order" value="${articleCategory.order}" maxlength="9" />
							</div>
						</div>
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-4">
					[#if articleCategory.builtin]
						<span class="btn btn-danger btn-sm">&nbsp;内置文章分类不允许修改&nbsp;</span>
					[#else]
