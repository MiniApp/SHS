...
<html lang="en">
	<head>
		...
		[#-- 标题 --]
		<title>撤销借款投资[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
	...
	[#-- borrowing.invest.rescind 借款投资撤销 --]
	<script type="text/javascript" src="${base}/resources/admin/js/borrowing.invest.rescind.min.js"></script>
    [#-- 有瞬时消息时 --]
	[#if flashMessage != null]
	    [#-- HubSpot Messenger 弹框（Alert）组件库 --]
