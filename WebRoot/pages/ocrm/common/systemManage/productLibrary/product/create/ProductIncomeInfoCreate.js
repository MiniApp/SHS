...
ObjectUtil
		.define(
				"crm.pages.ocrm.common.systemManage.productLibrary.product.create.ProductIncomeInfoCreate",
				"base.PageObject",
				{
					htmlUrl : Constants.CONTEXT_PATH
							+ "/pages/ocrm/common/systemManage/productLibrary/product/create/ProductIncomeInfoCreate.html",// 页面url地址
									...
									callback : function(data) {
										...
										DataUtil
												.populateDataForArea(
														...
														owner.ids.productIncomeInfoCreateContentDiv);// 渲染数据到页面
										HtmlUtil
						...
						this
								.create(
										'component.Panel',
										{
											title : '',
											// id :
											// "productIncomeInfoCreatePanel",
											contentEl : this.ids.productIncomeInfoCreateContentDiv,
											renderTo : this.ids.productIncomeInfoCreatePanelDiv,
					...
					createIncomeInfo : function() {
						...
						var data = DataUtil
								.getDataFromArea(owner.ids.productIncomeInfoCreateContentDiv);// 获取页面输入的信息并自动验证
