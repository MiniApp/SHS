...
<html lang="en">
	<head>
		...
		[#-- 标题 --]
		<title>还款还款计划[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
			...
			<div class="tabbable">
				...
				<div class="tab-content">
					...
					<div id="repay" class="tab-pane" tab-id="repay_tab">
						[#include "/template/admin/repayment_plan/repay_tab_pane.ftl" /]
					</div>
    ...
    [#-- repayment_plan.repay 还款计划还款 --]
	<script type="text/javascript" src="${base}/resources/admin/js/repayment_plan.repay.min.js"></script>
    [#-- 有瞬时消息时 --]
	[#if flashMessage != null]
	    [#-- HubSpot Messenger 弹框（Alert）组件库 --]
