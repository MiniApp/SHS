...
[#-- 索引URL --]
[#assign indexUrl = baseUrl + "/recharge_remedy" /]
<!DOCTYPE html>
<html lang="en">
	<head>
		[#-- meta 标签 --]
		...
		[#-- 标题 --]
		<title>补救充值[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
		...
		<div class="form-horizontal">
			...
			<div class="tabbable">
				...
				<ul class="nav nav-tabs">
					...
					[/#if]
					<li>
						<a id="remedy_tab" href="#remedy" data-toggle="tab">充值补救</a>
					</li>
				</ul>
	...
	[#-- recharge.remedy 充值补救 --]
	<script type="text/javascript" src="${base}/resources/admin/js/recharge.remedy.min.js"></script>
    [#-- 有瞬时消息时 --]
	[#if flashMessage != null]
	    [#-- HubSpot Messenger 弹框（Alert）组件库 --]
