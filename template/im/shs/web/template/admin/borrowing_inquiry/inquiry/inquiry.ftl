...
<div class="form-group">
	...
	<div class="col-sm-4">
		<input id="borrowingDate" class="form-control datetimepicker datetimepicker-yyyy-MM-dd" type="text" name="borrowingDate" value="${(borrowing.borrowingDate?string("yyyy-MM-dd"))!}" />
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-4">
		<input id="borrowingCorp" class="form-control" type="text" name="borrowingCorp" value="${borrowing.borrowingCorp}" maxlength="200" autocomplete="off" />
	</div>
</div>
--]
