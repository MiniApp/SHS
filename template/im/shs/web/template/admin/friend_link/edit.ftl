    ...
    <body class="contentwrapper">
		...
		<div id="jBreadCrumb" class="breadCrumb module">
			<ul>
				...
				<li>
					编辑${message("FriendLinkType." + friendLinkType)}
				</li>
			</ul>
		</div>
					
		[#-- 表单 --]
		<form id="inputForm" class="form-horizontal" action="${indexUrl}/${friendLink.id}" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input id="name" class="form-control" type="text" name="name" value="${friendLink.name}" maxlength="200" />
				</div>
			</div>
					...
					<div class="col-sm-4">
						[#if friendLink.logo??]
							<div class="input-group input-file">
								<input class="form-control file-name" value="${base}${friendLink.logo}" />
								<span class="input-group-btn">
									<span class="btn btn-default btn-file">
										修改图片
										<input id="logo" type="file" name="logoFile" />
									</span>
									<a href="${base}${friendLink.logo}" class="btn btn-default" target="_blank">查看图片</a>
								</span>
							</div>
						[#else]
							<div class="input-group input-file">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input id="url" class="form-control" type="text" name="url" value="${friendLink.url}" maxlength="200" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input id="order" class="form-control" type="text" name="order" value="${friendLink.order}" maxlength="9" />
				</div>
			</div>
