...
[#-- 索引URL --]
[#assign indexUrl = baseUrl + "/buyback" /]
<!DOCTYPE html>
<html lang="en">
	<head>
		[#-- meta 标签 --]
		...
		[#-- 标题 --]
		<title>回购列表[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
    ...
    <body class="contentwrapper">
		...
		<table class="table table-striped table-bordered dataTable">
			...
			<tbody>
				[#list list as buyback]
					<tr>
						[#-- 回购 List TD --]
						[#include "/template/admin/buyback/list_tds.ftl" /]
				        <td class="center">
				        	<a href="${baseUrl}/buyback_plan?buyback=${buyback.id}">
		...
		<div class="hide">
		    ...
		    <div class="dataTableActions">
				...
				[/#if]
		        <div class="btn-group">
					<a href="${indexUrl}[#if assignment??]?assignment=${assignment}[/#if]" class="btn btn-default btn-sm">
