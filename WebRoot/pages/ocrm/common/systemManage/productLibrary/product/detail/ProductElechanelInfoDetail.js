...
ObjectUtil
		.define(
				"crm.pages.ocrm.common.systemManage.productLibrary.product.detail.ProductElechanelInfoDetail",
				"base.PageObject",
				{
					htmlUrl : Constants.CONTEXT_PATH
							+ "/pages/ocrm/common/systemManage/productLibrary/product/detail/ProductElechanelInfoDetail.html",// 页面url地址
	...
	initData : function() {
						...
						ConnectionUtil.ajaxReq( {
							strServId : "productManageService.getElechanelInfoById",
	...
	updataBaseInfo : function() {
		...
		var win = owner.create(
										'component.Window',
										{
											...
											height : 300,
											modal : false,
											pageObject : owner.create('crm.pages.ocrm.common.systemManage.productLibrary.product.update.ProductElechanelInfoUpdate',//创建新增页面对象
															{
