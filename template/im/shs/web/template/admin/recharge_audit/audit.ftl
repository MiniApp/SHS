...
[#-- 索引URL --]
[#assign indexUrl = baseUrl + "/recharge_audit" /]
<!DOCTYPE html>
<html lang="en">
	<head>
		[#-- meta 标签 --]
		...
		[#-- 标题 --]
		<title>审核充值[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
		...
		<div class="form-horizontal">
			...
			<div class="tabbable">
				...
				<ul class="nav nav-tabs">
					...
					[/#if]
					<li>
						<a id="audit_tab" href="#audit" data-toggle="tab">充值审核</a>
					</li>
				</ul>
	...
	[#-- recharge.audit 充值审核 --]
	<script type="text/javascript" src="${base}/resources/admin/js/recharge.audit.min.js"></script>
    [#-- 有瞬时消息时 --]
	[#if flashMessage != null]
	    [#-- HubSpot Messenger 弹框（Alert）组件库 --]
