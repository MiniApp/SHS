...
ObjectUtil
		.define(
				"crm.pages.ocrm.common.systemManage.productLibrary.product.detail.ProductBorrowcardInfoDetail",
				"base.PageObject",
				{
					htmlUrl : Constants.CONTEXT_PATH
							+ "/pages/ocrm/common/systemManage/productLibrary/product/detail/ProductBorrowcardInfoDetail.html",// 页面url地址
	...
	updataBaseInfo : function() {
		...
		var win = owner.create(
										'component.Window',
										{
											...
											height : 300,
											modal : false,
											pageObject : owner.create('crm.pages.ocrm.common.systemManage.productLibrary.product.update.ProductBorrowcardInfoUpdate',//创建新增页面对象
															{
