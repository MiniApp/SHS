...
ObjectUtil
		.define(
				"crm.pages.ocrm.common.systemManage.productLibrary.product.update.ProductSellAreaInfoUpdate",
				"base.PageObject",
				{
					htmlUrl : Constants.CONTEXT_PATH
							+ "/pages/ocrm/common/systemManage/productLibrary/product/update/ProductSellAreaInfoUpdate.html",// 页面url地址
						...
						ConnectionUtil.ajaxReq( {
							...
							callback : function(data) {
								DataUtil.populateDataForArea(data.productSellAreaInfoBean,
										owner.ids.productSellAreaInfoUpdateContectDiv);// 渲染数据到页面
							}
						});
					},
	/**
...
//				});
		...
		this.create('component.Panel',{
					title : '',
					//id : "productSellAreaInfoUpdatePanel",
					contentEl : this.ids.productSellAreaInfoUpdateContectDiv,
					renderTo : this.ids.productSellAreaInfoUpdatePanelDiv,
	...
	updateSellAreaInfo : function() {
		var owner = this;
		var data = DataUtil.getDataFromArea(owner.ids.productSellAreaInfoUpdateContectDiv);// 获取页面输入的信息并自动验证
