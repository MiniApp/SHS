...
<html lang="en">
	<head>
		...
		[#-- 标题 --]
		<title>设置汇潮支付[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
	...
	[#-- payment_plugin.ecpss.setting 汇潮支付设置 --]
	<script type="text/javascript" src="${base}/resources/admin/js/payment_plugin.ecpss.setting.min.js"></script>
    [#-- 有瞬时消息时 --]
	[#if flashMessage != null]
	    [#-- HubSpot Messenger 弹框（Alert）组件库 --]
