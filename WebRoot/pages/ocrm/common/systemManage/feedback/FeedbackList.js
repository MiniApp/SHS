ObjectUtil
		.define(
				"crm.pages.ocrm.common.systemManage.feedback.FeedbackList",
				"base.PageObject",
				{
					htmlUrl : Constants.CONTEXT_PATH
							+ "/pages/ocrm/common/systemManage/feedback/FeedbackList.html",//页面地址
					/**
					 * 初始化頁面組件
					 * @param
					 * @return
