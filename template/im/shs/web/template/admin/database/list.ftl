...
[#-- 索引URL --]
[#assign indexUrl = baseUrl + "/database" /]
<!DOCTYPE html>
<html lang="en">
	<head>
		[#-- meta 标签 --]
		...
		[#-- 标题 --]
		<title>数据库即时备份[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
    ...
    <body class="contentwrapper">
		...
		<div class="hide">
		    ...
		    <div class="dataTableActions">
		        <div class="btn-group">
					<a href="${indexUrl}/backup" class="btn btn-default btn-sm">
						<i class="icon-plus"></i>
						备份
					</a>
