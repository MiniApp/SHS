      ...
      <div class="ACtHoPage_MOLes"> 
		...
		<div class="ACtHoPage_MedCtsRight">
			...
			<div class="MyBorFund_HeadK"> 
				<a href="${base}/account/repayment_plan?state=repaying">
				<div class="MyBorFund_HeadKa" style=" color:#555555; ">还款中借款</div>
				</a> 
				<a href="javascript:void(0);">
				<div class="MyBorFund_HeadKb" style=" color:#ffffff; ">已还清借款</div>
				</a> 
		    </div>
			<div class="BorrowFundsDetailb">
					...
					<table class="MyBorFund_btm">
						...
						[#list page.cont as repaymentPlan]
		                    ...
		                    <tr class="MyBorFund_btmb">
		                        ...
		                        <td>${(repaymentPlan.capital + repaymentPlan.interest)?string("currency")}</td>
		                        <td>${(repaymentPlan.paidCapital + repaymentPlan.paidInterest)?string("currency")}</td>
		                        <td>${(repaymentPlan.paidOverdueInterest)?string("currency")}</td>
								<td><a href="${base}/account/repayment_plan/${repaymentPlan.id}">查看</a></td>
		                    </tr>
		                [/#list]
		                [#if page.cont?size == 0]
