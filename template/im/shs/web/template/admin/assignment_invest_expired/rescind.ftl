...
[#-- 索引URL --]
[#assign indexUrl = baseUrl + "/assignment_invest_expired" /]
<!DOCTYPE html>
<html lang="en">
	<head>
		[#-- meta 标签 --]
		...
		[#-- 标题 --]
		<title>撤销转让申请[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
	...
	[#-- assignment.apply.rescind 转让申请撤销 --]
	<script type="text/javascript" src="${base}/resources/admin/js/assignment.apply.rescind.min.js"></script>
    [#-- 有瞬时消息时 --]
	[#if flashMessage != null]
	    [#-- HubSpot Messenger 弹框（Alert）组件库 --]
