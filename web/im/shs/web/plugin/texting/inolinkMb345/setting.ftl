...
[#-- 索引URL --]
[#assign indexUrl = baseUrl + "/texting_plugin" /]
<!DOCTYPE html>
<html lang="en">
	<head>
		[#-- meta 标签 --]
		...
		[#-- 标题 --]
		<title>设置凌凯Mb345短信 [#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
	...
	[#-- texting_plugin.inolink.setting 本地文件存储设置 --]
	<script type="text/javascript" src="${base}/resources/admin/js/texting_plugin.inolink.setting.min.js"></script>
    [#-- 有瞬时消息时 --]
	[#if flashMessage != null]
	    [#-- HubSpot Messenger 弹框（Alert）组件库 --]
