...
ObjectUtil
		.define(
				"crm.pages.ocrm.common.systemManage.productLibrary.product.update.ProductBorrowcardInfoUpdate",
				"base.PageObject",
				{
					htmlUrl : Constants.CONTEXT_PATH
							+ "/pages/ocrm/common/systemManage/productLibrary/product/update/ProductBorrowcardInfoUpdate.html",// 页面url地址
	...
	initData : function() {
		               ...
		               var owner = this;						
						...
						ConnectionUtil.ajaxReq( {
							strServId : "productManageService.getBorrowcardInfoById",
	...
	updateIdentify : function(){
		...
		if (data != Constants.VALIDATION_FAIL) {// 如果data不等Constants.VALIDATION_FAIL则表示验证通过
			...
			ConnectionUtil.ajaxReq({// 发送ajax请求
				strServId : "productManageService.updateBorrowcardInfo",
				jsonData : newData,
				callback : function(msg) {
					MsgUtil.alert("提示", "借记卡产品信息修改成功!");
