...
ObjectUtil
		.define(
				"crm.pages.ocrm.common.systemManage.productLibrary.product.update.ProductElechanelInfoUpdate",
				"base.PageObject",
				{
					htmlUrl : Constants.CONTEXT_PATH
							+ "/pages/ocrm/common/systemManage/productLibrary/product/update/ProductElechanelInfoUpdate.html",// 页面url地址
	...
	updateIdentify : function(){
		...
		if (data != Constants.VALIDATION_FAIL) {// 如果data不等Constants.VALIDATION_FAIL则表示验证通过
			...
			ConnectionUtil.ajaxReq({// 发送ajax请求
				strServId : "productManageService.updateElechanelInfo",
				jsonData : newData,
				callback : function(msg) {
					MsgUtil.alert("提示", "电子渠道产品信息修改成功!");
