...
<div class="form-group">
	...
	<div class="col-sm-4">
		<textarea id="riskAnalysis" class="form-control" name="riskAnalysis" cols="10" rows="5">${borrowing.riskAnalysis}</textarea>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="input-group col-sm-4">
		<input id="riskDegree" class="form-control" type="text" name="riskDegree" value="${borrowing.riskDegree}" maxlength="20" autocomplete="off" />
	...
	<div class="col-sm-4">
		<select id="creditRating" class="form-control chosen-select" name="creditRating" data-placeholder="&nbsp;">
			...
			[#list creditRatings as creditRating]
				<option value="${creditRating}"[#if borrowing.creditRating == creditRating] selected="selected"[/#if]>${message("CreditRating." + creditRating)}</option>
			[/#list]
		</select>
	</div>
</div>
	...
	<div class="input-group col-sm-4">
		<select id="investmentMethod" class="form-control chosen-select" name="investmentMethod" data-placeholder="&nbsp;">
			...
			[#list investmentMethods as investmentMethod]
				<option value="${investmentMethod}"[#if borrowing.investmentMethod == investmentMethod] selected="selected"[/#if]>${message("InvestmentMethod." + investmentMethod)}</option>
			[/#list]
			--]
			[#assign investmentMethod = borrowing.investmentMethod!"multiple_of_minimum" /]
...
<div class="form-group">
	...
	<div class="input-group col-sm-4">
		<label class="input-group-addon">￥</label>
		<input id="investmentMinimum" class="form-control" type="text" name="investmentMinimum" value="${borrowing.investmentMinimum}" maxlength="20" autocomplete="off" />
	</div>
</div>
...
<div class="form-group">
	...
	<div class="input-group col-sm-4">
		<label class="input-group-addon">￥</label>
		<input id="investmentMaximum" class="form-control" type="text" name="investmentMaximum" value="${borrowing.investmentMaximum}" maxlength="20" autocomplete="off" />
	</div>
</div>
--]
...
<div class="form-group">
	...
	<div class="input-group col-sm-4">
		<input id="investmentPeriod" class="form-control" type="text" name="investmentPeriod" value="${borrowing.investmentPeriod}" maxlength="20" autocomplete="off" />
	...
	<div class="col-sm-4">
		<select id="repaymentMethod" class="form-control chosen-select" name="repaymentMethod" data-placeholder="&nbsp;">
			...
			[#list repaymentMethods as repaymentMethod]
				<option value="${repaymentMethod}"[#if borrowing.repaymentMethod == repaymentMethod] selected="selected"[/#if]>${message("RepaymentMethod." + repaymentMethod)}</option>
			[/#list]
		</select>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="input-group col-sm-4">
		<input id="prepaymentFeeRate" class="form-control" type="text" name="prepaymentFeeRate" value="${borrowing.prepaymentFeeRate}" maxlength="20" autocomplete="off" />
		<label class="input-group-addon">%</label>
	</div>
</div>
--]
...
<div class="form-group">
	...
	<div class="input-group col-sm-4">
		<input id="feeRate" class="form-control" type="text" name="feeRate" value="${borrowing.feeRate}" maxlength="20" autocomplete="off" />
		<label class="input-group-addon">%</label>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="input-group col-sm-4">
		<input id="repaymentFeeRate" class="form-control" type="text" name="repaymentFeeRate" value="${borrowing.repaymentFeeRate}" maxlength="20" autocomplete="off" />
		<label class="input-group-addon">%</label>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="input-group col-sm-4">
		<input id="recoveryFeeRate" class="form-control" type="text" name="recoveryFeeRate" value="${borrowing.recoveryFeeRate}" maxlength="20" autocomplete="off" />
		<label class="input-group-addon">%</label>
	</div>
</div>
