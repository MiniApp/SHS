...
[#-- 索引URL --]
[#assign indexUrl = baseUrl + "/bank_card_modif" /]
<!DOCTYPE html>
<html lang="en">
	<head>
		[#-- meta 标签 --]
		...
		[#-- 标题 --]
		<title>修改银行卡[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
		...
		<div class="form-horizontal">
			...
			<div class="tabbable">
				...
				<ul class="nav nav-tabs">
					...
					[/#if]
					<li>
						<a id="modify_tab" href="#modify" data-toggle="tab">银行卡修改</a>
					</li>
				</ul>
				...
				<div class="tab-content">
					...
					<div id="modify" class="tab-pane" tab-id="modify_tab">
						[#-- 表单 --]
						<form id="inputForm" class="form-horizontal" action="${indexUrl}/${id}" method="post">
							[#if redirectType??]
							...
							[#-- 修改银行卡 --]
							[#include "/template/admin/bank_card/edit/basic.ftl" /]
    ...
    [#-- jQuery Select For Bind 绑定选择器 --]
	<script type="text/javascript" src="${base}/resources/lib/select/jquery.select.bind.min.js"></script>
	[#-- jBreadcrumbs 面包屑 --]
