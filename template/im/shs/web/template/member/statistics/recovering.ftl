            ...
            <div class="invest">
            	<div class="invest-title">
                	<ul>
                        ...
                        <li><a href="javascript:void(0);" class="active">待收统计</a></li>
                        <li><a href="${base}/account/statistics/recovered">已收统计</a></li>
                    </ul>
                </div>
                <div class="table">
                	<div class="statistics">
                        <div class="div-sty" style="margin:0px">
                            ...
                            <div class="pull-left txt-container">
                            	<ul>
                                	<li>
                                    	<p>信用认证标<span>${creditRecoveringAmts?string("currency")}</span></p>
                                    </li>
                                    <li>
                                    	<p>机构担保标<span>${guaranteeRecoveringAmts?string("currency")}</span></p>
                                    </li>
                                    <li>
                                    	<p>抵押质押标<span>${mortgageRecoveringAmts?string("currency")}</span></p>
                                    </li>
                                    <li id="border-no">
                                    	<label>总计：${recoveringAmts?string("currency")}</label>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
<script type="text/javascript">var creditAmts = ${creditRecoveringAmts}, guaranteeAmts = ${guaranteeRecoveringAmts}, mortgageAmts = ${mortgageRecoveringAmts};</script>
