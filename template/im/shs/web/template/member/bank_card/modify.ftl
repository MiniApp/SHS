	   	...
	   	<div class="right-content pull-right">
			...
			<div class="drawcash">
				<div class="drawcash-bank-new">
					<form id="bankcardForm" action="${base}/account/bank_card/${bankCard.id}" method="post">
						<table class="letter_table" style="margin-top: 0px; line-height: 31px;">
							...
							<tr>
								...
								<td style="color: red;">
									${secrecy("backcard", bankCard.card)}
									<p class="annotate" style="color: red; line-height: 14px; height: 14px; margin: 5px 0;"></p>
								</td>
							</tr>
							<tr>
								...
								<td>
									<input type="text" name="branchName" value="${bankCard.branchName}" class="text-one" placeholder="请输入开户行" />
									<p class="annotate" style="color: red; line-height: 14px; height: 14px; margin: 5px 0;"></p>
								</td>
							</tr>
							<tr>
								...
								<td>
									<input type="hidden" name="locality" value="${(bankCard.locality.id)!}" treePath="${(bankCard.locality.treePath)!}" class="text-one areaSelect" />
									<p class="annotate" style="color: red; line-height: 14px; height: 14px; margin: 5px 0;"></p>
								</td>
							</tr>
							<tr>
								...
								<td>
									<input type="checkbox" name="isDefault" value="true" [#if bankCard.isDefault] checked="checked"[/#if] />
									<input type="hidden" name="_isDefault" value="false" [#if !bankCard.isDefault] checked="checked"[/#if] />
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td align="right" valign="top">&nbsp;&nbsp;</td>
								<td>
									<span class="pull-left"><input type="submit" value="修改" class="btn-one" /></span>
...
<script type="text/javascript" src="${base}/resources/member/js/bank_card.modify.min.js?version=${setting.basic.siteVersion}"></script>
[#-- 瞬时消息 --]
