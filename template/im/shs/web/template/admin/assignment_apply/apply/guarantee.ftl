	...
	<div class="col-sm-4">
		<select id="guaranteeMethod" class="form-control chosen-select" name="guaranteeMethod" data-placeholder="&nbsp;">
			...
			[#list guaranteeMethods as guaranteeMethod]
				<option value="${guaranteeMethod}">${message("GuaranteeMethod." + guaranteeMethod)}</option>
			[/#list]
		</select>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="input-group col-sm-4">
		...
		<input id="guaranteeCapital" class="form-control" type="text" name="guaranteeCapital" maxlength="20" autocomplete="off" />
	</div>
</div>
--]
	...
	<div class="col-sm-4">
		<select id="guaranteeCorpId" class="form-control chosen-select" name="guaranteeCorpId" data-placeholder="&nbsp;">
			...
			[#list guaranteeCorps as guaranteeCorp]
				<option value="${guaranteeCorp.id}">${guaranteeCorp.corpName}</option>
			[/#list]
		</select>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-4">
		<textarea id="guarantee" class="form-control" name="guarantee" cols="10" rows="5"></textarea>
	</div>
</div>