...
<div class="content">
    <div class="rows">
      	...
      	<div class="right-content pull-right">
        	<div class="title size-14">我的借款统计</div>
            <div class="invest">
            	<div class="invest-title">
                	<ul>
                    	<li><a href="javascript:void(0);" class="active">借款统计</a></li>
                        <li><a href="${base}/account/statistics/repaying">待还统计</a></li>
                        <li><a href="${base}/account/statistics/repaid">已还统计</a></li>
                    </ul>
                </div>
                <div class="table">
                	<div class="statistics">
                        <div class="div-sty" style="margin:0px">
                            ...
                            <div class="pull-left txt-container">
                            	<ul>
                                	<li>
                                    	<p>信用认证标<span>${creditBorrowingAmts?string("currency")}</span></p>
                                    </li>
                                    <li>
                                    	<p>机构担保标<span>${guaranteeBorrowingAmts?string("currency")}</span></p>
                                    </li>
                                    <li>
                                    	<p>抵押质押标<span>${mortgageBorrowingAmts?string("currency")}</span></p>
                                    </li>
                                    <li id="border-no">
                                    	<label>总计：${borrowingAmts?string("currency")}</label>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
<script type="text/javascript">var creditAmts = ${creditBorrowingAmts}, guaranteeAmts = ${guaranteeBorrowingAmts}, mortgageAmts = ${mortgageBorrowingAmts};</script>
