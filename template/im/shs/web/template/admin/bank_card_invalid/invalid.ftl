...
[#-- 索引URL --]
[#assign indexUrl = baseUrl + "/bank_card_invalid" /]
<!DOCTYPE html>
<html lang="en">
	<head>
		[#-- meta 标签 --]
		...
		[#-- 标题 --]
		<title>作废银行卡[#if systemPowered] - Powered By ICLNetwork[/#if]</title>
		[#-- Link 顶部 --]
		...
		<div class="form-horizontal">
			...
			<div class="tabbable">
				...
				<ul class="nav nav-tabs">
					...
					[/#if]
					<li>
						<a id="invalid_tab" href="#invalid" data-toggle="tab">银行卡作废</a>
					</li>
				</ul>
				...
				<div class="tab-content">
					...
					[#-- 银行卡作废 --]
					<div id="invalid" class="tab-pane" tab-id="invalid_tab">
				    	[#-- 表单 --]
	...
	[#-- bank_card.invalid 银行卡作废 --]
	<script type="text/javascript" src="${base}/resources/admin/js/bank_card.invalid.min.js"></script>
    [#-- 有瞬时消息时 --]
	[#if flashMessage != null]
	    [#-- HubSpot Messenger 弹框（Alert）组件库 --]
