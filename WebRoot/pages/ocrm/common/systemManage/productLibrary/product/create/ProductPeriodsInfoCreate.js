...
ObjectUtil
		.define(
				"crm.pages.ocrm.common.systemManage.productLibrary.product.create.ProductPeriodsInfoCreate",
				"base.PageObject",
				{
					htmlUrl : Constants.CONTEXT_PATH
							+ "/pages/ocrm/common/systemManage/productLibrary/product/create/ProductPeriodsInfoCreate.html",// 页面url地址
					/**
					 * 初始化页面数据
					 * 
					 * @param
									...
									callback : function(data) {
										...
										DataUtil
												.populateDataForArea(
														...
														owner.ids.productPeriodsInfoCreateContentDiv);// 渲染数据到页面
									}
								});
					},
					/**
						...
						this
								.create(
										'component.Panel',
										{
											title : '',
											// id :
											// "productPeriodsInfoCreatePanel",
											contentEl : this.ids.productPeriodsInfoCreateContentDiv,
											renderTo : this.ids.productPeriodsInfoCreatePanelDiv,
					...
					createPeriodsInfo : function() {
						...
						var data = DataUtil
								.getDataFromArea(owner.ids.productPeriodsInfoCreateContentDiv);// 获取页面输入的信息并自动验证
