...
ObjectUtil
		.define(
				"crm.pages.ocrm.common.systemManage.productLibrary.product.create.ProductTradeLimitInfoCreate",
				"base.PageObject",
				{
					htmlUrl : Constants.CONTEXT_PATH
							+ "/pages/ocrm/common/systemManage/productLibrary/product/create/ProductTradeLimitInfoCreate.html",// 页面url地址
					/**
					 * 初始化页面数据
					 * 
					 * @param
									...
									callback : function(data) {
										...
										var compCheckbox = owner
												.create(
														...
														{
															renderTo : owner.ids.prodFuncLimitDiv,
										...
										DataUtil
												.populateDataForArea(
														...
														owner.ids.productTradeLimitInfoCreateContentDiv);// 渲染数据到页面
									}
								});
					},
					/**
					...
					initCmp : function() {
						...
						// renderTo : this.ids.prodFuncLimitDiv,
						// name:'prodFuncLimitList',
						// fieldType:'checkbox',
						// disabled : false,
						// items :[{label : '预约',value :
						// CodeStringDefinition.RESERVATION},
						// {label : '认购',value :
						// CodeStringDefinition.SUBSCRIBE},
						// {label : '申购',value : CodeStringDefinition.PURCHASE},
						// {label : '赎回',value :
						// CodeStringDefinition.REDEMPTION},
						// {label : '挂单',value :
						// CodeStringDefinition.PENDING_ORDER},
						// {label : '撤销',value :
						// CodeStringDefinition.REVOCATION},
						// {label : '质押',value : CodeStringDefinition.PLEDGE},
						// {label : '非交易过户',value :
						// CodeStringDefinition.NON_TRADING_TRANSFER}],
						...
						this
								.create(
										'component.Panel',
										{
											title : '',
											// id :
											// "productTradeLimitInfoCreatePanel",
											contentEl : this.ids.productTradeLimitInfoCreateContentDiv,
											renderTo : this.ids.productTradeLimitInfoCreatePanelDiv,
					...
					createTradeLimitInfo : function() {
						...
						var data = DataUtil
								.getDataFromArea(owner.ids.productTradeLimitInfoCreateContentDiv);// 获取页面输入的信息并自动验证
